...
Notes:
    ...
    sphinx-apidoc --private --separate --force --output-dir ~/code/sm64-random-assets/docs/source/auto ~/code/sm64-random-assets/sm64_random_assets
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/sm64-random-assets/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: sm64-random-assets
            Set the Repository URL: https://github.com/Erotemic/sm64-random-assets

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/sm64-random-assets/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/sm64-random-assets/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/sm64-random-assets/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'sm64_random_assets')
...
# html_logo = '.static/sm64-random-assets.svg'
# html_favicon = '.static/sm64-random-assets.ico'
...
latex_documents = [
    (master_doc, 'sm64-random-assets.tex', 'sm64-random-assets Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'sm64-random-assets', 'sm64-random-assets Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sm64-random-assets', 'sm64-random-assets Documentation',
     author, 'sm64-random-assets', 'One line description of project.',
     'Miscellaneous'),
]
